...
List.days_of_the_week = List(["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"])
    ...
    def visit_BinOpNode(self, node, context):
        ...
        if error:
            ...
            if isinstance(result, str):
                return res.success(String(result))
...
def version() -> str:
	return f"Infinity Lang {VERSION}"
